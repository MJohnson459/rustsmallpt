...
impl Scene {
    pub fn new() -> Scene {
        ...
        spheres.push(Sphere {radius: 600.0,       position: Vec3d{x: 50.0, y: 681.6 - 0.27, z: 81.6},         emission: Vec3d{x:4.0,y:4.0,z:4.0}, color: Vec3d{x:0.0,y:0.0,z:0.0}, reflection: ReflectType::DIFF}); // light
    ...
    pub fn new2() -> Scene {
        ...
        spheres.push(Sphere {radius: wall_radius,  position: Vec3d{x: wall_radius+1.0, y: room_height/2.0, z: room_depth/2.0},                      emission: Vec3d{x:0.0,y:0.0,z:0.0},    color: Vec3d::from_rgb(0xCC1A1A),   reflection: ReflectType::DIFF}); // left
        spheres.push(Sphere {radius: wall_radius,  position: Vec3d{x: -wall_radius+room_width-1.0, y: room_height/2.0, z: room_depth/2.0},          emission: Vec3d{x:0.0,y:0.0,z:0.0},    color: Vec3d::from_rgb(0x1A4DB3),   reflection: ReflectType::DIFF}); // right
    ...
    pub fn new3() -> Scene {
        ...
        spheres.push(Sphere {radius: wall_radius,  position: Vec3d{x: room_width/2.0, y: wall_radius, z: room_depth/2.0},                           emission: Vec3d{x:0.0,y:0.0,z:0.0},    color: Vec3d{x:0.75,y:0.75,z:0.75}, reflection: ReflectType::DIFF}); // bottom
        spheres.push(Sphere {radius: wall_radius,  position: Vec3d{x: room_width/2.0, y: -wall_radius+room_height, z: room_depth/2.0},              emission: Vec3d{x:0.0,y:0.0,z:0.0},    color: Vec3d{x:0.75,y:0.75,z:0.75}, reflection: ReflectType::DIFF}); // Top
        spheres.push(Sphere {radius: light_radius, position: Vec3d{x: room_width/2.0, y: room_height-light_radius, z: room_depth/2.0},         emission: Vec3d{x:4.0,y:4.0,z:4.0}*100.0, color: Vec3d{x:0.0,y:0.0,z:0.0},    reflection: ReflectType::DIFF}); // light
